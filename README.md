...
| **Backend & AI** | Node.js, Express, Django, Google GenAI SDK (Gemini) |
| **Tools & Platforms** | Git, GitHub, VS Code, Dev Tunneling, Postman |
| **Current Focus** | Advanced Contextual AI Orchestration & Omnichannel Automation |
...
<!--
**mvaishnavirekha/mvaishnavirekha** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
